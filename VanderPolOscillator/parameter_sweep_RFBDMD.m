%% RFB-EDMD Algorithm Application for Van der Pol Oscillator
% This script implements the Recursive Forward-Backward Extended Dynamic Mode 
% Decomposition (RFB-EDMD) algorithm on the Van der Pol oscillator system. The algorithm 
...
% Load pre-processed Van der Pol oscillator data from saved_data directory
...
epsilon_values = [0.00001,.01:.01:1];
