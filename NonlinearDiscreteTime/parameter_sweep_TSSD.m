%% Tunable SSD Algorithm Application for Nonlinear Discrete-Time System
% This script implements the Tunable Symmetric Subspace Decomposition (TSSD) 
% algorithm on the nonlinear discrete-time system. The algorithm is applied multiple 
...
% Load pre-processed nonlinear discrete-time system data from saved_data directory
