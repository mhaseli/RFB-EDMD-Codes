...
set(0, 'DefaultTextFontName', 'Times', ...
    ...
    legend('T-SSD', 'RFB-EDMD', 'Location', 'southeast');
    xlabel('$\epsilon$', 'Interpreter', 'latex');
    ylabel('$\dim$', 'Interpreter', 'latex');
    ylim([0,7])
    % Save the figure in PNG and EPS
    saveas(fig, fullfile(figuresDir, 'Dimvseps_discreteSystem.png'));
    print(fig, fullfile(figuresEpsDir, 'Dimvseps_discreteSystem'), '-depsc');
