%% RFB-EDMD Algorithm Application for Duffing Equation
% This script implements the Recursive Forward-Backward Extended Dynamic Mode 
% Decomposition (RFB-EDMD) algorithm on the Duffing Equation system. The algorithm 
