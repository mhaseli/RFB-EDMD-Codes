%% Tunable SSD Algorithm Application for Yeast Glycolysis System
% This script implements the Tunable Symmetric Subspace Decomposition (TSSD) 
% algorithm on the Yeast Glycolysis system. The algorithm is applied multiple 
...
% Load pre-processed yeast glycolysis data from saved_data directory
load('saved_data/trajectory_data.mat');
% Load pre-processed RFB-EDMD data containing dictionary and other parameters
